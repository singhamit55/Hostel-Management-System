...
function setupLoginHandlers() {
  ...
  if (btnStudent && btnAdmin) {
    btnStudent.onclick = () => {
      ...
      if (toggleWrap) toggleWrap.innerHTML = `<p style="font-size: 0.85rem; color: var(--text-secondary);">Don't have an account? <span id="btn-show-register" style="color: var(--accent-primary); font-weight: 600; cursor: pointer; text-decoration: underline;">Register Now</span></p>`;
    };
    ...
    btnAdmin.onclick = () => {
      ...
      if (helpText) helpText.style.display = "none";
      if (toggleWrap) toggleWrap.innerHTML = `<p style="font-size: 0.85rem; color: var(--text-secondary);">Don't have an account? <span id="btn-show-register" style="color: var(--accent-primary); font-weight: 600; cursor: pointer; text-decoration: underline;">Register Warden/Hostel</span></p>`;
    };
  }
...
// ==========================================
// STUDENT DYNAMIC VIEWS RENDERERS
// ==========================================
